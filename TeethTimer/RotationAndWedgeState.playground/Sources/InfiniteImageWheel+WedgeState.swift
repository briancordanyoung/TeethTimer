...
//      return description
    ...
    public var positiveLayoutAngle: Angle {
    ...
    public var negativeLayoutAngle: Angle {
      switch directionFromSelectedWedge {
      case .Clockwise:
        return Angle(rotationState.wedgeCenter - centerDistanceToSelectedWedge)
    ...
    public var percentToNextWedge: Double {
    ...
    public var distanceToRotation: Rotation {
